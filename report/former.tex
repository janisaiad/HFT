...
\section{Modélisation par processus de Hawkes}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{Exemple 1.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{Exemple 2 better.png}
    ...
    \begin{figure}[H]
        \centering
        \fbox{\rule{0pt}{4cm}\qquad\rule{8cm}{0pt}} % Placeholder pour l'image 3
    ...
    \begin{figure}[H]
        \centering
        \fbox{\rule{0pt}{4cm}\qquad\rule{8cm}{0pt}} % Placeholder pour l'image 4
